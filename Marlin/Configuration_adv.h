...
#define USE_CONTROLLER_FAN
  ...
  //#define CONTROLLER_FAN_PIN -1           // Set a custom pin for the controller fan -- set in PINS file
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  // #define Z_STEPPER_ALIGN_XY { { 49 , 10 }, { 235,  235 }}
